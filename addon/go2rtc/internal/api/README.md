...
The HTTP API can be explored in the upstream [interactive viewer](https://go2rtc.org/api/),
which is generated from go2rtc's OpenAPI description. WebSocket API described
[here](ws/README.md).
